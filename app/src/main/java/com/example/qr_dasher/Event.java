...
//    }
    ...
    public void addAttendee(User attendee) {
        if (attendee == null) {
            throw new IllegalArgumentException("AttendeeDashboard cannot be null.");
        }
        if (attendee_list.contains(attendee)) {
            throw new IllegalArgumentException("AttendeeDashboard already exists in the attendee list.");
        }
        attendee_list.add(attendee);
    }
    public void removeAttendee(User attendee) {
        if (!attendee_list.contains(attendee)) {
            throw new NoSuchElementException("AttendeeDashboard not found in the attendee list.");
        }

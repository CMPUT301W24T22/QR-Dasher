    ...
    private void addUserToFirestore(User user) {
        usersCollection.add(user)
                .addOnSuccessListener(documentReference -> {
                    Toast.makeText(HomePage.this, "User added to Firestore", Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(HomePage.this, "Error adding user to Firestore: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
}
